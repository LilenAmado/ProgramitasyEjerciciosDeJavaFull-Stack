...
//SUMA
    private void sumaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sumaActionPerformed
        ...
        if(num1.getText().equals("") || num2.getText().equals("")){
            ...
            //advertir campos vacios
            resultado.setText("Alguno de los campos está vacío");
            
            //CARTEL DE ADVERTENCIA
            JOptionPane advertencia = new JOptionPane("Alguno de los campos está vacío");
            advertencia.setMessageType(JOptionPane.WARNING_MESSAGE);
            JDialog dialogo = advertencia.createDialog("ADVERTENCIA");
...
//RESTA
    private void restaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_restaActionPerformed
        ...
        if(num1.getText().equals("") || num2.getText().equals("")){
            ...
            //CARTEL DE ADVERTENCIA
            JOptionPane advertencia = new JOptionPane("Alguno de los campos está vacío");
            advertencia.setMessageType(JOptionPane.WARNING_MESSAGE); //error / information
            JDialog dialogo = advertencia.createDialog("ADVERTENCIA");
            dialogo.setVisible(true);
            dialogo.setAlwaysOnTop(true);
        }else{
